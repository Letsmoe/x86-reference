...
-   **Company** (referred to as either "the Company", "We", "Us" or "Our" in
    this Cookies Policy) refers to META.
-   **Cookies** means small files that are placed on Your computer, mobile
    device or any other device by a website, containing details of your browsing
    history on that website among its many uses.
-   **Website** refers to META, accessible from
    [https://meta-lang.com](https://meta-lang.com)
-   **You** means the individual accessing or using the Website, or a company,
    or any legal entity on behalf of which such individual is accessing or using
...
[All About Cookies by TermsFeed](https://www.termsfeed.com/blog/cookies/).

### Contact Us

If you have any questions about this Cookies Policy, You can contact us:

-   By email: info@meta-lang.com
